<x-filament-panels::page>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="col-span-1 md:col-span-3 p-6 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg shadow text-white">
            ...
            <p class="text-lg opacity-90">
                This is your personal recruitment space. Start your journey with us today.
            </p>
        </div>
        ...
        <div class="dashboard-card">
            <div class="flex items-center justify-between">
                <div>
                    <p class="dashboard-card-title">Total Applications</p>
        ...
        <div class="dashboard-card">
            <div class="flex items-center justify-between">
                <div>
                    <p class="dashboard-card-title">Pending</p>
        ...
        <div class="dashboard-card">
            <div class="flex items-center justify-between">
                <div>
                    <p class="dashboard-card-title">Completed</p>
    ...
    @else
        <div class="dashboard-card" style="text-align: center; padding: 2rem;">
            <p style="color: #999; font-size: 1.1rem;">No applications yet. Start your first application!</p>
        </div>
    @endif
</x-filament-panels::page>