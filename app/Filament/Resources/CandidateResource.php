    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Select::make('status')
                ...
                ->required(),
            Forms\Components\TextInput::make('primary_score')->numeric(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\IconColumn::make('cv_path')->label('CV')->boolean()
                    ->trueIcon('heroicon-o-document')->falseIcon('heroicon-o-x-mark'),
                Tables\Columns\TextColumn::make('created_at')->label('Date')->dateTime()->sortable(),
            ])
            ->actions([
                Tables\Actions\Action::make('voir_cv')
                    ->label('View CV')->icon('heroicon-o-document')
                ...
                Tables\Actions\Action::make('approuver')
                    ...
                    ->action(function ($record) {
                        ...
                        Notification::make()->title('Candidate approved!')->success()->send();
                    })
