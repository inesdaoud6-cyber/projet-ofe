            ...
            Forms\Components\Section::make('Question Content')
                ->schema([
                    ...
                    Forms\Components\Textarea::make('question_en')
                        ->label('Question (EN) — auto-translated')
                        ->disabled()
                        ->columnSpanFull(),
                    Forms\Components\Textarea::make('question_ar')
                        ->label('Question (AR) — auto-translated')
                        ->disabled()
                        ->columnSpanFull(),
                ]),
            ...
            Forms\Components\Section::make('Configuration')
                ->schema([
                    ...
                    Forms\Components\TextInput::make('max_note')
                        ->label('Maximum Score')->numeric()->default(0),
                    Forms\Components\TextInput::make('second_ratio')
                        ->label('Secondary Ratio')->numeric()->default(0),
